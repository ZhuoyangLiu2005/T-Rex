...
from qwen_vla.modeling_qwen35_mot import Qwen35ModelMoT
...
def train(args):
    ...
    for epoch in range(args.n_epochs):
        ...
        for batch in it:
            ...
            # ── M-RoPE position_ids for latent tokens ────────────────────────
            ...
            # ── Extend position_ids ───────────────────────────────────────────
            # pos_ids: [3, B, L_latent] (Qwen3.5 M-RoPE format)
            ...
            full_pos  = Qwen35ModelMoT._extend_position_ids(
                pos_ids, n_action, n_tactile,
                attention_mask=batch["attention_mask"])   # [3, B, L_total]
