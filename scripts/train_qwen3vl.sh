...
BASE_RUN_NAME="qwen3vl_2b_tri_mot_pretrainvlm_pick_cube_0303view2_tacdeform_wostate_deltabase_eef_stride2_right_crop_f1s1_0319"
...
# Set to a previously trained VLA checkpoint (.pt) for warm-starting action expert
ACTION_MODEL_PATH=""
