...
DATA_JSON="/mnt/amlfs-02/shared/human_egocentric/dniu/Dex-MoT/mot_arch/data/bkl_inlab/training_data/three_full_json/open_airpods_0325_deltabase_axis_eef_bimanual_stride2_train.json"
...
MASTER_ADDR=10.244.111.39 # run 'ifconfig' to get the ip address of eth0
MASTER_PORT=29500
NUM_MACHINES=2
