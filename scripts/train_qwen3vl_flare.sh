...
RUN_NAME="qwen3vl_2b_mot[3]_pretrain[egodex0407]_midtrain[none]_task[fold_shorts_0426]_traj[100]_view[3]_tac[force+deform]_state[wo]_stride[1]_flare[tpf4step8stride4]_$(date +%m%d)"
